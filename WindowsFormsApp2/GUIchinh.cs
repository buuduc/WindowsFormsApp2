                ...
                case 1:
                    {
                        ...
                        //String g = gridView2.GetSelectedRows()[0].ToString();
                        //this.k = danhsachnhanvienBindingSource.Find("Maso", g);
                        //MessageBox.Show(k.ToString());
                        //string row = gridView3.GetFocusedRowCellValue("Maso").ToString();
                        //this.k = danhsachnhanvienBindingSource.Find("Maso", row);
                        this.k = thongtinnhanvienBindingSource.Position;
                    break;
                    }
                case 2:
                    {
